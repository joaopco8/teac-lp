...
export function AboutSectionPT() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden border border-slate-200">
              ...
              <div className="p-4">
                <Image 
                  src="/images/mod3.jpg" 
                  alt="Por que Estamos Perdidos e Sem Memória"
                  width={300}
                  height={200}
                  className="w-full h-auto object-cover mb-4"
                />
                <h4 className="font-bold text-slate-900 mb-2">Desvendando mistérios</h4>
                <p className="text-sm text-slate-600">
                  Compreenda as razões por trás da nossa desconexão espiritual e como o TEAC restaura a memória cósmica.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden border border-slate-200">
              ...
              <div className="p-4">
                <Image 
                  ...
                  className="w-full h-auto object-cover mb-4"
                />
                <h4 className="font-bold text-slate-900 mb-2">Sua missão cósmica</h4>
                <p className="text-sm text-slate-600">
                  Entenda como os projetos estelares moldam sua jornada e como alinhar-se com sua verdadeira missão espiritual.
                </p>
              </div>
            </div>
