...
export function PriceSectionPT() {
  return (
      ...
      <div className="container max-w-5xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <div className="mb-4">
            ...
            <p className="text-2xl font-bold text-slate-900">Não vai custar 500€, mas apenas...</p>
          </div>

          <div className="mb-8">
            <p className="text-center mb-2">
              <span className="line-through text-slate-900 opacity-60">500€</span>
              <span className="bg-green-500 text-white text-sm rounded-full px-2 py-1 ml-2">352€ OFF</span>
            </p>

            <div className="flex items-center justify-center gap-2">
              <p className="text-5xl font-bold text-slate-900 !text-slate-900" style={{ color: '#1e293b' }}>
                <span className="text-[80px] leading-none !text-slate-900" style={{ color: '#1e293b' }}>148€</span><span className="text-3xl !text-slate-900" style={{ color: '#1e293b' }}></span>
              </p>
            </div>
          ...
          <div className="flex justify-center gap-4 mt-6">
            <img 
              ...
              alt="Hotmart" 
              className="h-16 opacity-25 filter grayscale" 
              style={{ width: 'auto' }}
            />
          </div>
